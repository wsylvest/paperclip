...
const ADAPTER_TYPE = "kimi_local";

/**
 * Estimate the cost of a kimi_local run before execution.
 *
 ...
 *     Rationale: mirrors claude-local heuristic; most CLI sessions produce ~30% of
 *     input as output, capped at 8000 tokens.
 *
