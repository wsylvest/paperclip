...
const ADAPTER_TYPE = "gemini_local";

/**
 * Estimate the cost of a gemini_local run before execution.
 *
 ...
 *
 * Returns null when no matching pricing row is found (including for the "auto" model
 * selection, which has no deterministic pricing row).
 */
