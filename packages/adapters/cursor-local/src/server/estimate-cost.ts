...
const ADAPTER_TYPE = "cursor_local";

/**
 * Estimate the cost of a cursor (cursor_local) run before execution.
 *
 * Cursor proxies Anthropic by default (sonnet-4-6 at the time of writing).
 * If the agent config specifies a different model/provider, those override the defaults.
 *
