...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="company/settings/mcp" element={<Mcp />} />
      {/* Wildcard plugin settings route MUST stay after specific settings routes
          (mcp, pricing, etc.) so it doesn't swallow them. */}
